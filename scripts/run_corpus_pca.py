...
Usage (on moissanite):
    python scripts/run_corpus_pca.py /path/to/libs/data [--pattern '**/*AverageSpectrum.csv'] [--out data/results.pkl]
    python scripts/run_corpus_pca.py /dir1 /dir2 /dir3 --gpu --out data/results.pkl
...
def main():
    ...
    parser.add_argument('--out', default='data/corpus_pca_results.pkl',
